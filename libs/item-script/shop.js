var base_frontend_url = 'https://lk.easynetshop.ru/frontend/v5/frontend-test.php';
...
ens_jQuery(document).ready(function() {
    ...
    if (window['EasyNetShop'] == undefined) {
        ...
        ens_jQuery('body').append('<div class="easynetshop-modalcontainer">' +
            '<div class="easynetshop-modal easynetshop-modal-addtocart"><div class="easynetshop-modal-header"><button type="button" class="easynetshop-close">×</button><span class="easynetshop-modal-title easynetshop-modal-caption">Товар добавлен в корзину</span></div><div class="easynetshop-modal-body easynetshop-center"><button type="button" class="easynetshop-continue">Вернуться на сайт</button><button type="button" class="easynetshop-gotocart">Оформить заказ</button><br></div><div class="easynetshop-recomended"></div><div class="easynetshop-footer"><div style="padding-top: 5px;"><span style="background-color: #df0000;color: #fff;padding: 5px;">Тестовая версия</span><br>Получите рабочую версию в личном кабинете.</div></div></div>' +
            '<div class="easynetshop-modal easynetshop-modal-cart"><div class="easynetshop-modal-header"><button type="button" class="easynetshop-close">×</button><span class="easynetshop-modal-title easynetshop-modal-caption">Оформление заказа</span><div style="padding-top: 5px;"><span style="background-color: #df0000;color: #fff;padding: 5px;">Тестовая версия</span> Получите рабочую версию в личном кабинете.</div></div><div class="easynetshop-modal-body"></div><div class="easynetshop-recomended"></div><div class="easynetshop-footer"><button type="button" class="easynetshop-continue">Вернуться на сайт</button> <button type="button" class="easynetshop-doorder">Заказать</button><br><span class="powered"><span class="powered-append">Работает на </span><a href="https://easynetshop.ru/?utm_source=partners&utm_medium=referral" target="_blank">EasyNetShop.ru</a></a></span></div></div>' +
